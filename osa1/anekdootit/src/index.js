...
const App = (props) => {
  ...
  const highestVoted = () => votes.reduce((iMax, x, i, arr) => x > arr[iMax] ? i : iMax, 0);
  ...
  return (
    <div>
      ...
      <p>
        <Button clickHandler={() => setVoteState()} text="vote" />
        <Button clickHandler={() => setSelected(randomize())} text="next anecdote" />
      </p>
